...
export default function   WhatsAppButton() {
  ...
  const handleWhatsAppClick = () => {
    ...
    const phoneNumber = '+905XXXXXXXXX'; // Update this with your actual WhatsApp number
    const message = 'Merhaba! Likya Catering hakkında bilgi almak istiyorum.';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Tooltip */}
      {isHovered && (
        <div className="absolute bottom-1/2 right-full transform translate-y-1/2 mr-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg shadow-lg whitespace-nowrap">
